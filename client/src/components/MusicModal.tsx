...
const MusicModal = ({
  ...
  return (
    <>
      ...
      >
        <div
          className={`z-40 border relative border-indigo-300/30 bg-indigo-500/40 rounded-lg duration-300 transition-all ease-in-out w-full max-w-sm overflow-hidden ${
            musicModalOpen
              ? ""
